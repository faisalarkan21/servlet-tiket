...
<body>
	<div id="navbarpro" class="navbar navbar-fixed-top navbar-inverse">
        ...
        <span class="icon-bar"></span>
				...
				<a class="navbar-brand" href="<%=request.getContextPath()%>/user/dashboard.jsp">Dashboard Tiket <i style="padding-left: 6px;" class="fa fa-users fa-fw " aria-hidden="true"></i>
 ...
 Halaman Pembeli </div>
		...
		<div class="menu-list">
			<ul id="menu-content" class="menu-content collapse out">
				<li >
					<a  style="display: block;" href="<%=request.getContextPath()%>/halaman-user/user/dashboard.jsp">
